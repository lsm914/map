...
# ---------- 2) 기준 테이블 ----------
lawd_df = pd.read_csv(REF_DIR / "lawd_codes.csv")  # 컬럼: lawd_cd(5자리), sido_nm, sigungu_nm
cent_df = pd.read_csv(REF_DIR / "sigungu_centroids.csv")  # 컬럼: lawd_cd, lat, lng, region_group(수도권/특광역시/지방)
